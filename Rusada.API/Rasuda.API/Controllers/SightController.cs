...
namespace Rasuda.API.Controllers
{
    ...
    public class SightController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<SightDetails>>> Get()
        {
        ...
        [HttpPost]
        [Route("InsertSight")]
        public async Task<int> Post(SightDetails sight)
        {
        ...
        public async Task<ActionResult<SightDetails>> GetById(int id)
        {
        ...
        [HttpPut]
        [Route("UpdateSight")]
        public async Task<ResponseObject> Put(SightDetails sight)
        {
